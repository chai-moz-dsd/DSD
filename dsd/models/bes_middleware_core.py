...
class BesMiddlewareCore(models.Model):
    ...
    cases_malaria_confirmed_5 = models.IntegerField(default=0, null=True)
    cases_diarrhea_04 = models.IntegerField(null=True)
    cases_malaria_clinic_0_4 = models.IntegerField(default=0, null=True)
    ...
    note_malaria_clinic = models.CharField(max_length=255, null=True)
    ...
    deaths_malaria_clinic_0_4 = models.IntegerField(default=0, null=True)
    ...
    cases_malaria_clinic_5 = models.IntegerField(default=0, null=True)
    deaths_malaria_clinic_5 = models.IntegerField(default=0, null=True)
    ...
    note_malaria_confirmed = models.CharField(max_length=255, null=True)
    ...
    middleware_facility_id = models.IntegerField(null=True)
    middleware_district_id = models.IntegerField(null=True)
    middleware_province_id = models.IntegerField(null=True)
    middleware_stale = models.IntegerField(null=True)
