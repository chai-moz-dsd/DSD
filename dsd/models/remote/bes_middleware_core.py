...
class BesMiddlewareCore(models.Model):
    ...
    note_malaria_clinic = models.CharField(max_length=255, db_column='NOTE_MALARIA_CLINIC', null=True)
    note_malaria_confirmed = models.CharField(max_length=255, db_column='NOTE_MALARIA_CONFIRMED', null=True)
