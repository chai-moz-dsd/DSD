...
VERSION = 24
DHIS2_1_ENV_DOCKERCLOUD_SERVICE_FQDN = os.environ.get('DHIS2_1_ENV_DOCKERCLOUD_SERVICE_FQDN', 'http://52.32.36.132')
DHIS2_PORT_8080_TCP_PORT = os.environ.get('DHIS2_PORT_8080_TCP_PORT', '80')
DHIS2_BASE_URL = '%s:%s/' % (DHIS2_1_ENV_DOCKERCLOUD_SERVICE_FQDN, DHIS2_PORT_8080_TCP_PORT)
