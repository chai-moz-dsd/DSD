...
class AlertServiceTest(TestCase):
    def test_should_get_alert_status(self):
        ...
        AlertFactory(rule_group=rule_group_id, rule_level=4, org_unit=24, should_alert=False)
    ...
    def test_should_update_alert_status(self):
        ...
        AlertFactory(rule_group=rule_group_id, rule_level=4, org_unit=75, should_alert=False)
